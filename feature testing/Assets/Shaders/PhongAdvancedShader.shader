Shader "Blackwood/PhongAdvancedShader" {
    Properties 
    {
    ...
    SubShader 
    {
        ...
        Pass 
        {
          ...
          fixed4 frag(v2f i) : COLOR
          {
              ...
              {
                  //Specular component
                  specularReflection = attenuation * _LightColor0.rgb * _SpecColor.rgb * pow(max(0.0, dot(reflect(-lightDirection, normalDirection), viewDirection)), _Shininess) * 1;
              }
